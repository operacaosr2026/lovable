...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SRX Growth" },
      { name: "description", content: "Sistema de organização: finanças, projetos e ecommerce." },
      { name: "author", content: "SRX Growth" },
      { property: "og:title", content: "SRX Growth" },
      { property: "og:description", content: "Sistema de organização: finanças, projetos e ecommerce." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "SRX Growth" },
      { name: "twitter:description", content: "Sistema de organização: finanças, projetos e ecommerce." },
      { name: "theme-color", content: "#7c6af7" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "SRX Growth" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
    ],
    links: [
      { rel: "icon", type: "image/png", href: "/favicon-preto.png" },
