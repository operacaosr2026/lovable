...
function GroupDetail() {
  ...
  if (!group) return (
    <PageShell>
      ...
      <Link to="/shops/banco-de-lojas" search={{ view: "esteira" }} className="text-sm text-primary mt-3 inline-block">← Voltar</Link>
    </PageShell>
  );
  ...
  return (
    <PageShell>
      ...
      <div className="flex items-center gap-3 mb-3">
        <Link to="/shops/banco-de-lojas" search={{ view: "esteira" }} className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground shrink-0">
