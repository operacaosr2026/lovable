...
// Pausa a sincronização automática (crons + sino) das lojas desta coluna —
// ver getPausedShopifyStoreIds em sync-pause.server.ts.
export const setBoardColumnSyncPaused = createServerFn({ method: "POST" })
  .middleware([requireOwnerContext])
  .inputValidator((d) => z.object({
    id: z.string().uuid(),
    paused: z.boolean(),
